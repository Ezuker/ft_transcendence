...
from PongRemoteHandler.routing import websocket_urlpatterns as PongRemoteHandler_websocket_urlpatterns
...
application = ProtocolTypeRouter({
    ...
    "websocket": AuthMiddlewareStack(
        URLRouter(
            Connect4Handler_websocket_urlpatterns + MatchMakingHandler_websocket_urlpatterns + PongRemoteHandler_websocket_urlpatterns
        )
    ),
})